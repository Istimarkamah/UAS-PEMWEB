...
@section('content')
    <h1 class="text-3xl font-bold underline text-center"> Daftar Buku</h1>
    <h2 class="text-xl font-bold">Selamat Datang {{ Auth::user()->role }}</h2>
    <div class="flex justify-between mt-10">
        ...
        @can('pimpinan')
            <button
                ...
                type="button">
                <a href="/laporan">Unduh Laporan</a>
            </button>
        @endcan
    ...
    <div id="crud-modal" tabindex="-1" aria-hidden="true"
        class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(50%-1rem)] max-h-full">
        <div class="relative p-4 w-full max-w-md max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <!-- Modal body -->
                <form class="p-4 md:p-5" action="/create" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        ...
                        <div class="col-span-2">
                            ...
                            <textarea id="description" rows="4"
                                ...
                                placeholder="Write product description here" name="deskripsi"></textarea>
                        </div>
                    </div>
                    <button type="submit"
    ...
    <div class="relative overflow-x-auto border shadow mt-3">
            ...
            <tbody>
                ...
                @foreach ($datas as $data)
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4">
                            <img src="{{ asset('images/' . $data->gambar) }}" alt="image" width="50"
                                height="50">
                        </td>
                        <td class="px-6 py-4">
